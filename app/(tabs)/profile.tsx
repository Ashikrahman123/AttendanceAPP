...
export default function ProfileScreen() {
  ...
  const userSummaries = summaries.filter(summary => summary.userId === user.id);
  const totalHoursWorked = userSummaries.reduce((total, summary) => total + summary.totalHours, 0);
  const totalOvertimeHours = userSummaries.reduce((total, summary) => total + summary.overtimeHours, 0);
    ...
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
        ...
        <View style={[styles.profileCard, { 
          ...
          <View style={styles.statsContainer}>
            <View style={styles.statItem}>
              <Text style={[styles.statValue, { color: colors.primary }]}>{formatHours(totalHoursWorked)}</Text>
            ...
            <View style={styles.statItem}>
              <Text style={[styles.statValue, { color: colors.primary }]}>{formatHours(totalOvertimeHours)}</Text>
            ...
            <View style={styles.statItem}>
              <Text style={[styles.statValue, { color: colors.primary }]}>{checkIns}</Text>
              <Text style={[styles.statLabel, { color: colors.textSecondary }]}>Days Worked</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.sectionContainer}>
          ...
          <View style={[styles.infoCard, { 
            ...
            <View style={styles.infoItem}>
              <View style={[styles.infoIcon, { backgroundColor: colors.primaryLight + '40' }]}>
            ...
            <View style={styles.infoItem}>
              ...
              <View style={styles.infoContent}>
                <Text style={[styles.infoLabel, { color: colors.textSecondary }]}>Regular Hours</Text>
                <Text style={[styles.infoValue, { color: colors.text }]}>
          ...
          <View style={[styles.settingsCard, { 
            ...
            >
              <View style={styles.settingsLeft}>
                <View style={[styles.settingsIcon, { backgroundColor: colors.primaryLight + '30' }]}>
                  <Clock size={20} color={colors.primary} />
                </View>
                <Text style={[styles.settingsText, { color: colors.text }]}>Working Hours</Text>
              </View>
            ...
            >
              <View style={styles.settingsLeft}>
                <View style={[styles.settingsIcon, { backgroundColor: colors.secondaryLight + '30' }]}>
                  <Calendar size={20} color={colors.secondary} />
                </View>
                <Text style={[styles.settingsText, { color: colors.text }]}>Leave Management</Text>
              </View>
              <ChevronRight size={20} color={colors.textSecondary} />
            </TouchableOpacity>
            ...
            >
              <View style={styles.settingsLeft}>
                <View style={[styles.settingsIcon, { backgroundColor: colors.info + '30' }]}>
        ...
        <View style={[styles.modalOverlay, { backgroundColor: 'rgba(0, 0, 0, 0.5)' }]}>
          <View style={[styles.modalContent, { backgroundColor: colors.background }]}>
            <View style={[styles.modalHeader, { borderBottomColor: colors.border }]}>
              <Text style={[styles.modalTitle, { color: colors.text }]}>Working Hours</Text>
              <TouchableOpacity 
            ...
            <ScrollView style={styles.modalBody}>
              <View style={styles.inputGroup}>
                <Text style={[styles.inputLabel, { color: colors.text }]}>Regular Hours Per Day</Text>
              ...
              <View style={styles.inputGroup}>
                ...
                <TextInput
                  ...
                  onChangeText={(text) => setWorkingHours({...workingHours, startTime: text})}
                  placeholder="09:00"
                  placeholderTextColor={colors.textSecondary}
                />
              </View>
              ...
              <View style={styles.inputGroup}>
                ...
                <TextInput
                  ...
                  onChangeText={(text) => setWorkingHours({...workingHours, endTime: text})}
                  placeholder="17:00"
                  placeholderTextColor={colors.textSecondary}
                />
              </View>
              ...
              <View style={styles.inputGroup}>
                <Text style={[styles.inputLabel, { color: colors.text }]}>Break Duration</Text>
                <View style={[styles.hoursInputContainer, { 
                  borderColor: colors.border,
                  backgroundColor: colors.card,
                }]}>
                  <TextInput
                    ...
                    onChangeText={(text) => {
                      ...
                      setWorkingHours({...workingHours, breakDuration: duration});
                    }}
                    keyboardType="numeric"
                    maxLength={3}
                    placeholderTextColor={colors.textSecondary}
                  />
                  <Text style={[styles.hoursUnit, { color: colors.textSecondary }]}>minutes</Text>
                </View>
              </View>
              
              <View style={[styles.modalNote, { backgroundColor: colors.cardAlt }]}>
                <Text style={[styles.noteText, { color: colors.textSecondary }]}>
                  Note: These settings will be used to calculate your working hours and overtime.
                </Text>
              </View>
            </ScrollView>
      ...
      >
        <View style={[styles.modalOverlay, { backgroundColor: 'rgba(0, 0, 0, 0.5)' }]}>
          <View style={[styles.modalContent, { backgroundColor: colors.background }]}>
            <View style={[styles.modalHeader, { borderBottomColor: colors.border }]}>
              <Text style={[styles.modalTitle, { color: colors.text }]}>Leave Management</Text>
              <TouchableOpacity 
                style={[styles.closeButton, { backgroundColor: colors.cardAlt }]}
            ...
            <ScrollView style={styles.modalBody}>
              <View style={[styles.leaveBalanceContainer, { 
                ...
                <Text style={[styles.leaveBalanceTitle, { color: colors.text }]}>Leave Balance</Text>
                ...
                <View style={styles.leaveBalanceRow}>
                  <View style={styles.leaveBalanceItem}>
                    ...
                    <Text style={[styles.leaveBalanceLabel, { color: colors.textSecondary }]}>Annual</Text>
                  </View>
                  ...
                  <View style={styles.leaveBalanceItem}>
                    ...
                    <Text style={[styles.leaveBalanceLabel, { color: colors.textSecondary }]}>Sick</Text>
                  </View>
                  ...
                  <View style={styles.leaveBalanceItem}>
                    ...
                    <Text style={[styles.leaveBalanceLabel, { color: colors.textSecondary }]}>Personal</Text>
                  </View>
                </View>
              </View>
              ...
              <View style={[styles.leaveRequestsContainer, { 
                ...
                <Text style={[styles.leaveRequestsTitle, { color: colors.text }]}>Recent Leave Requests</Text>
                
                {leaveRequests.length > 0 ? (
                  leaveRequests.map((request) => (
                    <View key={request.id} style={[styles.leaveRequestItem, { 
                      ...
                      <View style={styles.leaveRequestHeader}>
                        ...
                        <Text style={[styles.leaveRequestDate, { color: colors.textSecondary }]}>
                          {formatDate(new Date(request.startDate))} - {formatDate(new Date(request.endDate))}
                        </Text>
                      </View>
                      <Text style={[styles.leaveRequestType, { color: colors.text }]}>
                        {request.type.charAt(0).toUpperCase() + request.type.slice(1)} Leave
                      </Text>
                      <Text style={[styles.leaveRequestReason, { color: colors.textSecondary }]}>
                        {request.reason}
                      </Text>
                    </View>
                  ))
                  ...
                  <View style={styles.emptyLeaveRequests}>
                    ...
                    <Text style={[styles.emptyLeaveRequestsText, { color: colors.textSecondary }]}>
              ...
              <View style={[styles.newLeaveRequestContainer, { 
                backgroundColor: colors.card,
                borderColor: colors.border,
              }]}>
                <Text style={[styles.newLeaveRequestTitle, { color: colors.text }]}>New Leave Request</Text>
                
                <View style={styles.leaveFormGroup}>
                  <Text style={[styles.leaveFormLabel, { color: colors.text }]}>Leave Type</Text>
                    ...
                    {['vacation', 'sick', 'personal', 'other'].map((type) => (
                      <TouchableOpacity
                        ...
                        style={[
                          ...
                          leaveRequest.type === type && [styles.leaveTypeButtonActive, { 
                            backgroundColor: colors.primary + '20',
                            borderColor: colors.primary,
                          }],
                          { borderColor: colors.border }
                        ]}
                        onPress={() => setLeaveRequest({
                          ...leaveRequest,
                          type: type as any,
                        })}
                      >
                        <Text style={[
                          ...
                          leaveRequest.type === type && { color: colors.primary }
                        ]}>
                ...
                <View style={styles.leaveFormGroup}>
                  <Text style={[styles.leaveFormLabel, { color: colors.text }]}>Start Date</Text>
                  <TouchableOpacity 
                ...
                <View style={styles.leaveFormGroup}>
                  <Text style={[styles.leaveFormLabel, { color: colors.text }]}>End Date</Text>
                  <TouchableOpacity 
                    style={[styles.datePickerButton, { 
                      backgroundColor: colors.cardAlt,
                      borderColor: colors.border,
                ...
                <View style={styles.leaveFormGroup}>
                  <Text style={[styles.leaveFormLabel, { color: colors.text }]}>Reason</Text>
                  <TextInput
      ...
      >
        <View style={[styles.modalOverlay, { backgroundColor: 'rgba(0, 0, 0, 0.5)' }]}>
          <View style={[styles.modalContent, { backgroundColor: colors.background }]}>
            <View style={[styles.modalHeader, { borderBottomColor: colors.border }]}>
              <Text style={[styles.modalTitle, { color: colors.text }]}>Attendance Reports</Text>
              <TouchableOpacity 
                style={[styles.closeButton, { backgroundColor: colors.cardAlt }]}
            ...
            <ScrollView style={styles.modalBody}>
              <View style={[styles.reportTypesContainer, { 
                ...
                >
                  <View style={[styles.reportTypeIcon, { backgroundColor: colors.primaryLight + '30' }]}>
                    <CalendarRange size={24} color={colors.primary} />
                  </View>
                  <View style={styles.reportTypeContent}>
                    <Text style={[styles.reportTypeName, { color: colors.text }]}>Monthly Report</Text>
                ...
                >
                  <View style={[styles.reportTypeIcon, { backgroundColor: colors.secondaryLight + '30' }]}>
                    <Clock size={24} color={colors.secondary} />
                  </View>
                  <View style={styles.reportTypeContent}>
                    <Text style={[styles.reportTypeName, { color: colors.text }]}>Overtime Report</Text>
                    <Text style={[styles.reportTypeDescription, { color: colors.textSecondary }]}>
                ...
                >
                  <View style={[styles.reportTypeIcon, { backgroundColor: colors.info + '30' }]}>
                    <FileText size={24} color={colors.info} />
                  </View>
                  <View style={styles.reportTypeContent}>
                    <Text style={[styles.reportTypeName, { color: colors.text }]}>Custom Report</Text>
                    <Text style={[styles.reportTypeDescription, { color: colors.textSecondary }]}>
              ...
              <View style={[styles.reportActionsContainer, { 
                ...
                <Text style={[styles.reportActionsTitle, { color: colors.text }]}>Recent Reports</Text>
                ...
                <View style={styles.reportActionsList}>
                  <TouchableOpacity style={styles.reportActionItem}>
                    <View style={styles.reportActionLeft}>
                      ...
                      <View>
                        <Text style={[styles.reportActionName, { color: colors.text }]}>
                          April 2023 Monthly Report
                        </Text>
                        <Text style={[styles.reportActionDate, { color: colors.textSecondary }]}>
                          Generated on May 1, 2023
                        </Text>
                      </View>
                    </View>
                    <View style={styles.reportActionButtons}>
                      <TouchableOpacity style={[styles.reportActionButton, { backgroundColor: colors.cardAlt }]}>
      ...
      >
        <View style={[styles.modalOverlay, { backgroundColor: 'rgba(0, 0, 0, 0.5)' }]}>
          <View style={[styles.modalContent, { backgroundColor: colors.background }]}>
            <View style={[styles.modalHeader, { borderBottomColor: colors.border }]}>
              <Text style={[styles.modalTitle, { color: colors.text }]}>App Settings</Text>
              <TouchableOpacity 
                style={[styles.closeButton, { backgroundColor: colors.cardAlt }]}
              ...
              <View style={[styles.settingGroup, { 
                ...
                <View style={styles.settingItem}>
                  ...
                  <Switch
                    ...
                    trackColor={{ false: '#D1D5DB', true: colors.primaryLight }}
                    thumbColor={appSettings.notifications ? colors.primary : '#FFFFFF'}
                  />
                </View>
                ...
                <View style={styles.settingItem}>
                  <View style={styles.settingLeft}>
                    ...
                    <Text style={[styles.settingLabel, { color: colors.text }]}>Face Verification</Text>
                  </View>
                  <Switch
                    value={appSettings.faceVerificationRequired}
                    onValueChange={(value) => 
                      setAppSettings({...appSettings, faceVerificationRequired: value})
                    }
                    trackColor={{ false: '#D1D5DB', true: colors.primaryLight }}
                    thumbColor={appSettings.faceVerificationRequired ? colors.primary : '#FFFFFF'}
                  />
                </View>
                ...
                <View style={styles.settingItem}>
                  <View style={styles.settingLeft}>
                    ...
                    <Text style={[styles.settingLabel, { color: colors.text }]}>Location Tracking</Text>
                  </View>
                  <Switch
                    ...
                    trackColor={{ false: '#D1D5DB', true: colors.primaryLight }}
                    thumbColor={appSettings.locationTracking ? colors.primary : '#FFFFFF'}
                  />
                </View>
              </View>
              
              <View style={[styles.modalNote, { backgroundColor: colors.cardAlt, marginTop: 20 }]}>
                <Text style={[styles.noteText, { color: colors.textSecondary }]}>
